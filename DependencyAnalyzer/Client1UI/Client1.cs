/**************************************************************************************************
 *FileName      : Client.cs - Dependency Analyzer Client 2
 *Version       : 2.0
    ...
    public class Client1
    {
        ...
        public void startClient()
        {
            ...
            try
            {
                ...
                receive.CreateRecvChannel("http://localhost:8083/MyDependencyAnalyzer");
        ...
        internal void analyze()
        {
            ...
            if (MainWindow.windwObj.Type.IsChecked == true)
            {
                if (MainWindow.windwObj.Server1.IsChecked == true)
                {
                    ...
                    msg.src = new Uri("http://localhost:8083/MyDependencyAnalyzer");
      ...
      static void Main (string[] args)
      {
             ...
             client.startClient();
             Client1 clnt = Client1.getInstance();
             clnt.analyze();
      }
#endif
    }
