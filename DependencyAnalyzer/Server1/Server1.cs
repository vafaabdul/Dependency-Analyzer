/**************************************************************************************************
 *FileName      : Server.cs - Dependency Analyzer Server 2
 *Version       : 1.0
...
namespace DependencyAnalyzer
{
    ...
    public class Receiver : IMessageService
    {
        ...
        public List<Elem> buildTypeTable()
        {
            ...
            myPatterns.Add("*.cs");
            string[] myFiles = myAnal.getFiles("../../../../TestProjectsServer1", myPatterns, true);
        ...
        {
            Sender server = new Sender("http://localhost:8080/MyDependencyAnalyzer");
            SvcMsg msg1 = new SvcMsg();
            msg1.src = new Uri("http://localhost:8081/MyDependencyAnalyzer");
            msg1.dst = new Uri("http://localhost:8080/MyDependencyAnalyzer");
        ...
        {
            string[] myProjects = Directory.GetDirectories("../../../../TestProjectsServer1", "*");
        ...
        public void sendPkgDependency(SvcMsg msg, List<Elem> myTypeTable)
        {
            ...
            {
                string[] files = anal.getFiles("../../../../TestProjectsServer1/" + projectList[i], patterns, false);
        ...
        public void sendTypeTable(SvcMsg msg)
        {
            ...
            string[] files = anal.getFiles("../../../../TestProjectsServer1", patterns, true);
    ...
    public class Server1
    {
        ...
        {
            Console.WriteLine("Starting Message Service on Server1");
